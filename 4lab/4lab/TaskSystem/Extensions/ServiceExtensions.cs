...
public static class ServiceExtensions
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var rabbitMqConfig = configuration.GetSection("RabbitMq").Get<RabbitMqConfiguration>() ?? new RabbitMqConfiguration();
        services.AddSingleton(rabbitMqConfig);
        services.AddSingleton<IJobMessageProducer, JobMessageProducer>();
        ...
        services.AddScoped<IMessageBasedJobService, MessageBasedJobService>();
        services.AddSingleton<IJobMessageConsumer>(serviceProvider =>
            new JobMessageConsumer(serviceProvider.GetRequiredService<RabbitMqConfiguration>(), serviceProvider));
